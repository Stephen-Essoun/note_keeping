...
class DeleteNote extends ChangeNotifier implements UseCase<Note,Params<Note>>{
  final NoteRepository repo;

  DeleteNote(this.repo);
  DeleteNote.empty():repo = NoteRepositoryImpl.empty();
  @override
  Future<Either<Failure, Note>> call(Params<Note> params) async {
    return await repo.delete(params.data);
  }
